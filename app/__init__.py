...
def create_app():
    ...
    # JWT Secret Key
    app.config['JWT_SECRET_KEY'] = os.getenv('JWT_SECRET_KEY', 'super-secret')  # ⬅️ use env var in production
